...
export class ImagesComponent implements OnInit {
    ...
    constructor(private formManager: ServiceFormManagerService, private activatedRoute: ActivatedRoute, private activeUser: HttpAuthService, private imageService: ImageServices){}
