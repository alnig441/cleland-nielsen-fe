...
let LoginComponent = class LoginComponent {
    constructor(http, router, authService, httpAuth) {
        this.http = http;
        this.router = router;
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [http_1.HttpClient, router_1.Router, auth_service_1.AuthService, httpAuth_service_1.HttpAuthService])
], LoginComponent);
...
const core_1 = __webpack_require__(3);
const http_1 = __webpack_require__(34);
const SiteCopy = __webpack_require__(204);
...
const forms_1 = __webpack_require__(668);
...
module.exports = "<div *ngFor=\"let user of this.users.users as users; index as i\"><div class=\"col-sm-6 col-md-4\"><div class=\"box-shadow panel panel-info\" id=\"{{user.user_id}}\"><div class=\"panel-heading\"><h3 class=\"panel-title\">{{user.user_name}}</h3></div><div class=\"panel-body\"><p> Account Type: {{user.account_type}}</p><p> Language: {{user.language}}</p></div><div class=\"panel-footer\" (click)=\"edit(this.user)\">edit</div><div class=\"panel-footer\" (click)=\"delete(this.user)\">delete</div></div></div></div>"
...
//# sourceMappingURL=app.f46e82627ab5026126be.js.map